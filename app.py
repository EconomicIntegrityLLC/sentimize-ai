"""PixelForge — Image Art Studio by Economic Integrity LLC.
...
if source is None:
    ...
    st.markdown(
        '<div class="hero-box">'
        '  <p class="hero-title">PixelForge — Image Art Studio</p>'
